 ...
 * XListView
 * 
 * 根据Maxwin的XListView改造而来，参考Github链接：https://github.com/Maxwin-z/XListView-
 * Android
 */
public class XListView extends ListView implements OnScrollListener {
	 private static final String TAG = XListView.class.getName();
	...
	public void setPullLoadEnable(boolean enable) {
		...
		if (!mEnablePullLoad) {
			Log.d(TAG, "in setPullLoadEnable mEnablePullLoad = " + mEnablePullLoad);
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		default:
			...
			if (getFirstVisiblePosition() == 0) {
				...
				Log.d(TAG, "mEnablePullLoad = " + mEnablePullLoad);
				if (mEnablePullLoad
